				...
				<fieldset class="form-group col-md-6">
				 ...
				 <fieldset class="form-group col-md-6">
					...
					{{ Form::text('start_date', null , $attributes = array('class'=>'input-sm datepicker-input form-control', 'placeholder' => '2016-06-12','readonly'=>true,'id'=>'dpd1')) }}
				</fieldset>

				<fieldset class="form-group col-md-6">
					{{ Form::label('end_date', getphrase('end_date')) }}
					{{ Form::text('end_date', null , $attributes = array('class'=>'input-sm datepicker-input form-control', 'placeholder' => '2016-06-12','readonly'=>true,'id'=>'dpd2')) }}
				</fieldset>
			</div>
						...
						{{ Form::textarea('description', $value = null , $attributes = array('class'=>'form-control ckeditor', 'rows'=>'5', 'placeholder' => getPhrase('description'))) }}
						 ...
						 <div class="form-group">
                            <div class="col-md-12 clear">
                                ...
                                <a href="{{URL_EXAM_SERIES}}" class="btn btn-default">{{getPhrase('cancel')}}</a>
