	...
	{{ Form::label('topic_id', getphrase('topic')) }} <span class="text-danger">*</span>
	...
	<fieldset class="form-group">
		...
		{{ Form::textarea('question', $value = null , $attributes = array('class'=>'form-control ckeditor', 'placeholder' => 'Eg : Your question', 'rows' => '5',
		'ng-model'=>'question', 
		'id'=>'question',
...
<div class="col-md-6">
	...
	<fieldset class="form-group">
		...
		<span class="text-danger">*</span>
		{{ Form::number('marks', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => 'Eg : 1',
			'min'=>'1',
