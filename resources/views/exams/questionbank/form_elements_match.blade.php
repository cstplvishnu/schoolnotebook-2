...
<div ng-if="question_type=='match'">
    ...
    <div ng-if="total_answers > 0" class="row">
     ...
     <fieldset class="form-group col-md-5" >
        <label >{{getPhrase('left_title')}}</label> <span class="text-danger">*</span>
     ...
     <fieldset class="form-group col-md-5" >
        <label >{{getPhrase('right_title')}}</label> <span class="text-danger">*</span>
    ...
    <fieldset class="form-group col-md-5" >
        <label >{{getPhrase('left_option')}} @{{ $index+1 }}</label> <span class="text-danger">*</span>
    ...
    <fieldset class="form-group col-md-5" >
        <label >Right Option @{{ $index+1 }}</label> <span class="text-danger">*</span>
    ...
    <fieldset class="form-group col-md-2" >
        <label >Answer @{{ $index+1 }}</label> <span class="text-danger">*</span>
