                    ...
                    <div class="col-md-12">
                      <input checked="" id="free" name="option" required="true" type="checkbox">
                         <label for="free">
                            ...
                            </span>The computer provided to me is in proper working condition. I have read and understood the instructions given above.
                         </label>
                         <div class="text-center">
                           <button class="btn button btn-lg btn-primary">START Exam</button>
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
