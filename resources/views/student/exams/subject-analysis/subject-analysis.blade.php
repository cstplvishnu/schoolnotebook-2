...
<section class="panel panel-default">
  <header class="panel-heading bg-light">
	<ul class="nav nav-tabs nav-justified">
       <li class="active"><a data-toggle="tab" href="#academic_details"><i class="fa fa-list"></i> {{getPhrase('marks')}}</a></li>
       <li><a data-toggle="tab" href="#personal_details"><i class="fa fa-clock-o"></i> {{getPhrase('time')}}</a></li>
        </ul>
         </header>
<br>
