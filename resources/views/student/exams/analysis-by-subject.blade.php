...
<div class="row">
                  <div class="col-sm-12">
                     <section class="panel panel-default">
                       <header class="panel-heading font-bold"><strong> {{ $title.' '.getPhrase('of').' '.$user->name .' '.getPhrase('in').' '.$exam_record->title.' '.getPhrase('exam') }} </strong></header>
                         <div class="row">
                           <div class="col-sm-12">
                    ...
                    <header class="panel-heading bg-light">
				        ...
				        <li class="active"><a data-toggle="tab" href="#academic_details" class="font-bold"><i class="fa fa-list"></i> {{getPhrase('marks')}}</a></li>

						<li><a data-toggle="tab" href="#personal_details" class="font-bold"><i class="fa fa-clock-o"></i> {{getPhrase('time')}}</a></li>
					...
					<div class="tab-content tab-content-style">
					 ...
					 <h4 style="padding-left: 18px"> {{getPhrase('time_is_shown_in_seconds')}}</h4>
