...
<div class="login-content installation-page" >
  ...
  <div class="logo text-center"><img src="{{IMAGES}}logo.png" alt="" height="50%" width="50%"></div>
	  <div class="info">
		<h3 class="text-center">Server Hosting Details</h3>
		 <hr>
          <p class="text-center">Please enter server login details to install this system </p>
         </div>
         
         
        <div class="row">
          <div class="col-sm-12 ss-bottom">
        ...
        <div class="row">
          <div class="col-sm-12">
             <div class="text-center buttons clearfix">
               <button type="button" class="btn btn-next btn-info" ng-disabled='!registrationForm.$valid' onclick="submitForm();" >Next</button>
	        </div>
          </div>
        </div>
	</div>
