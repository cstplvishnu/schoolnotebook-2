			...
			<div class="row">
                   ...
                   <div class="col-md-3">
						...
						<i class="fa fa-exchange"></i>
								...
								<p class="card-text">{{ getPhrase('student_transfers')}}</p>
							</div>
							<a class="card-footer text-muted" 
					...
					<div class="col-md-3">
						<div class="card card-red text-xs-center helper_step9">
							<div class="card-block">
							<h4 class="card-title">
								<i class="fa fa-money" aria-hidden="true"></i>
					
							</h4>
								<p class="card-text">{{ getPhrase('fee_paid_history_for_class_wise')}}</p>
							</div>
							<a class="card-footer text-muted" 
