...
') }}</div>
                  ...
                  <div class="row">
						...
						<fieldset class="form-group col-md-4">
							...
							{{ Form::text('date_of_join', $value = date('Y/m/d') , $attributes = array('class'=>'input-sm  datepicker-input form-control', 'placeholder' => '2015/7/17', 'id'=>'dp','readonly'=>true)) }}
                     ...
                     @if($record->academic_id!=0||$record->course_parent_id!=0||$record->course_id!=0)
						...
						<div class="col-md-6 col-md-offset-3">
						  <?php 
						   $data        = getSetting('education_system_in_spring_and_fall_mode','site_settings');
						   $divide_year = array('S'=>getPhrase('spring'),'F'=>getPhrase('fall')); 
						  ?>
						  @if($data!='no')

						  <fieldset class="form-group">
                        {{ Form::label ('student_belongsto', getphrase('student_belongs_to')) }}
                        {{ Form::select('student_belongsto', $divide_year,null, 
                        [   'class'     => 'form-control',
                             'placeholder'=> getphrase('select'),
                            "id"        => "select_academic_year",
                            "ng-model"  => "student_belongsto",
					...
					<div class="col-md-12">
						...
						<fieldset class="form-group col-md-4">
							...
							{{ Form::number('previous_highest_qualification_percentage', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => '85.9')) }}
						</fieldset>

						<fieldset class="form-group col-md-4">
							{{ Form::label('year_passing', getphrase('year_passed')) }}
							{{ Form::number('year_passing', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => '2016')) }}
						</fieldset>
