	...
	<div class="row">
		...
		@if($join_date=='')
						...
						<fieldset class="form-group col-md-4">
					       ...
					       {{ Form::text('date_of_join', null , $attributes = array('class'=>'input-sm  datepicker-input form-control', 'placeholder' => '2016-06-12','readonly'=>true)) }}
...
@endif
	...
	<div class="row">
		...
		<fieldset class="form-group col-md-3">
			...
			<span class="text-danger">*</span>
			{{ Form::number('total_experience_years', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => '5')) }}
		</fieldset>
		
		<fieldset class="form-group col-md-3">
			{{ Form::label('experience (Months)', getphrase('experience (Months)')) }}
			<span class="text-danger">*</span>
			{{ Form::number('total_experience_month', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => '5')) }}
		</fieldset>
