<div class="table-responsive"> 
						...
						<tr>
							...
							<td><a href="{{URL_SUBJECTS_VIEW_TOPICS.$subject_record->slug}}" data-toggle="tooltip" data-placement="auto" title="view"  class="btn btn-sm btn-icon btn-primary"><i class="fa fa-eye"></i></a></td>
						</tr>
