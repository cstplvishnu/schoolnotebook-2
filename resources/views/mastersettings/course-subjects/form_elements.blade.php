	...
	<fieldset ng-if="academic_year" class="form-group col-md-6 col-md-offset-3">
    ...
    <fieldset ng-if="parent_selected" class="form-group col-md-6 col-md-offset-3">
	...
	<div ng-if="course_selected > 0" class="buttons col-md-12 text-center">
         ...
         <button class="btn btn-info">{{ getPhrase('load') }}</button>
	</div>
	  </div>		
