				 ...
				 <div class="row">
					<div class="col-md-3">
					  ...
					  <h4 class="card-title">
                        ...
                        <p class="card-text">{{ getPhrase('bonafide_contents')}}</p>
							...
							href="{{URL_SETTINGS_VIEW."conteudo-cert"}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
					<div class="col-md-3">
					  ...
					  <h4 class="card-title">
						  ...
						  <i class="fa fa-cogs" aria-hidden="true"></i>
							...
							<a class="card-footer text-muted" 
							href="{{URL_SETTINGS_VIEW."congif-cert"}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
                   <div class="col-md-3">
						<div class="card card-red text-xs-center">
							...
							<a class="card-footer text-muted" 
							href="{{URL_SETTINGS_VIEW."campos-certtr"}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
					<div class="col-md-3">
						<div class="card card-blue text-xs-center">
                          ...
                          <i class="fa fa-wrench" aria-hidden="true"></i>
							...
							<a class="card-footer text-muted" 
							href="{{URL_SETTINGS_VIEW."config-certtr"}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
					 <div class="col-md-3">
						<div class="card card-orange text-xs-center">
							...
							<a class="card-footer text-muted" 
							href="{{URL_SETTINGS_VIEW."campos-id"}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
					<div class="col-md-3">
						<div class="card card-yellow text-xs-center">
							...
							<a class="card-footer text-muted" 
							href="{{URL_SETTINGS_VIEW."config-id"}}">
								{{ getPhrase('view_all')}}
							</a>
						</div>
					</div>
