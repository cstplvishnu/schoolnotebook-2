...
define('DOWNLOAD_LINK_OFFLINE_MARKS_IMPORT_EXCEL', PREFIX1.'downloads/excel-templates/offline_marks_template.xlsx');


define('DOWNLOAD_EMPTY_DATA_DATABASE', PREFIX1.'downloads/database/install.sql');
define('DOWNLOAD_SAMPLE_DATA_SCHOOL_DATABASE', PREFIX1.'downloads/database/install_dummy_data_school.sql');
define('DOWNLOAD_SAMPLE_DATA_COLLEGE_DATABASE', PREFIX1.'downloads/database/install_dummy_data_college.sql');
define('DOWNLOAD_SAMPLE_DATA_DEGREE_DATABASE', PREFIX1.'downloads/database/install_dummy_data_degree.sql');
define('DOWNLOAD_SAMPLE_DATA_PG_DATABASE', PREFIX1.'downloads/database/install_dummy_data_pg.sql');
define('DOWNLOAD_SAMPLE_DATA_UNIVERSITY_DATABASE', PREFIX1.'downloads/database/install_dummy_data_university.sql');
...
define('URL_GET_FEE_PAID_DETAILS_OF_CLASS', PREFIX.'students/feepaid/history');
define('URL_PRINT_STUDENTS_PAIDFEE_CLASSWISE', PREFIX.'students/feepaid/history/print');
...
// //FEE SETTINGS--FEE CATEGORIES
// define('URL_FEE_CATEGORIES_ALLOT', PREFIX.'fee/categories/allot-category'); /*ToRemove*/
// define('URL_FEE_CATEGORIES_GET_ALLOT_CATEGORIES', PREFIX.'fee/categories/get_alloted-categories'); /*ToRemove*/
...
define('URL_USERS_FORGOT_PASSWORD', PREFIX.'forgot-password');
...
define('URL_USER_FEE_SCHEDULES', PREFIX.'users/fee-schedules/');
define('URL_USER_FEE_PAID_HISTORY', PREFIX.'users/fee-paid-history/');
...
define('URL_CLASS_WISE_FEE_PAID_HISTORY', PREFIX.'class/feepaid-history');
...
define('URL_FEE_CATEGORIES_DELETE', PREFIX.'fee/categories/delete/');
define('URL_FEE_CATEGORIES_AJAXLIST', PREFIX.'fee/categories/getList');
define('URL_FEE_CATEGORY_SCHEDULES', PREFIX.'fee/category/schedule/');
define('URL_FEE_CATEGORIES_SHEDULES_ADD', PREFIX.'fee/category/schedule-add');
define('URL_FEE_DELETE_FEESCHEDULES', PREFIX.'fee/schedule/delete');
...
//FEE CATEGORY PARTICULARS
define('URL_FEE_CATEGORY_PARTICULARS', PREFIX.'fee/category-particulars/');
define('URL_ADD_FEE_PARTICULARS_TO_CATEGORY', PREFIX.'fee/category-particulars/update/');
...
//FEE RECEIPTS
define('URL_FEE_DASHBOARD', PREFIX.'fee/dashboard'); 
define('URL_FEE_ACCEPT',PREFIX.'fee/payfee');
define('URL_GET_FEE_CATEGORY_STUDENTS',PREFIX.'fee/category/students');
define('URL_STUDENT_FEE_PAYMENT_DETAILS',PREFIX.'fee/student/feepay');
define('URL_STUDENT_FEE_PAY_ADD',PREFIX.'fee/feepay/particular');

//FEE PAY ONLINE
define('URL_FEE_PAY_ONLINE',PREFIX.'feepay/online/checkout');
define('URL_PAYNOW_FEE',PREFIX.'paynow/fee');
define('URL_PAYU_FEE_PAYMENT_SUCCESS',PREFIX.'paynow/fee/pau-success');
define('URL_PAYU_FEE_PAYMENT_CANCEL',PREFIX.'paynow/fee/pau-cancel');
define('URL_PAYPAL_FEE_PAYMENT_SUCCESS',PREFIX.'paynow/fee/paypal-success');
define('URL_PAYPAL_FEE_PAYMENT_CANCEL',PREFIX.'paynow/fee/paypal-cancel');
define('URL_UPDATE_OFFLINE_FEE_PAYMENT',PREFIX.'paynow/fee/offline');
define('URL_FEE_REPORTS_OFFLINE',PREFIX.'fee/offline/payments');
define('URL_FEE_OFFLINE_REPORTS_AJAXLIST',PREFIX.'fee/offline/payments/getlist');
define('URL_GET_FEE_PAYMENT_RECORD',PREFIX.'fee/offline/get-payment');
define('URL_PAYMENT_APPROVE_OFFLINE_FEE_PAYMENT',PREFIX.'fee/offline/approve/payment');

//FEE REPORTS
define('URL_FEE_REPORTS',PREFIX.'fee/reports');
define('URL_FEE_REPORTS_DAILY',PREFIX.'fee/reports/daily');
define('URL_FEE_REPORTS_DAILY_AJAXLIST', PREFIX.'fee/reports/daily/getList');
define('URL_FEE_REPORTS_GET_DAILYREPORTS', PREFIX.'fee/reports/getdaily/payments');
define('URL_FEE_REPORTS_GET_DATES_REPORTS', PREFIX.'fee/reports/dates/payments');
define('URL_FEE_REPORTS_GET_LASTWEEKREPORTS', PREFIX.'fee/reports/lastweek/payments');
define('URL_FEE_REPORTS_GET_LASTMONTHREPORTS', PREFIX.'fee/reports/lastmonth/payments');


define('URL_STUDENT_FEE_SCHEDULES_DETAILS',PREFIX.'student/feeschedule/details');
define('URL_STUDENT_FEE_PAID_HISTORY',PREFIX.'student/feepaid-history');

define('URL_PRINT_FEE_RECEIPT',PREFIX.'fee/print-receipt/');


define('URL_STUDENT_ONLINE_REGISTRATION',PREFIX.'student/online-registration');
define('URL_GET_USERS_SEARCH',PREFIX.'get/users-search');
