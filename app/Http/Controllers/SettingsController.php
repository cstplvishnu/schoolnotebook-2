...
class SettingsController extends Controller
{
     ...
     public function settingsDashboard()
    {
      ...
      $data['sub_active_class']   = 'all_settings';
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
               ...
               $link_data = '<div class="m-drop">
                      ...
                      <a href="'.URL_SETTINGS_VIEW.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-success"><i class="fa fa-eye"></i></a>

                      <a href="'.URL_SETTINGS_EDIT.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a></div>';
        ...
        ->editColumn('title', function($records){
        	return '<strong><a href='.URL_SETTINGS_VIEW.$records->slug.'>'.ucwords($records->title).'</strong></a>';
        })
        ->removeColumn('id')
        ->removeColumn('slug')
