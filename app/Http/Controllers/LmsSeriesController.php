    ...
    {$data['module_helper']      = getModuleHelper('lms-series-list');
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        $records = array();
            ...
            $records = LmsSeries::select(['image','title',  'is_paid', 'cost', 'validity',  'total_items','slug', 'id', 'updated_at'])
        ...
        ->addColumn('action', function ($records) {
             ...
             $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_LMS_SERIES_UPDATE_SERIES.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("update_series").'"  class="btn btn-sm btn-icon btn-success"><i class="fa fa-spinner"></i></a>

                      <a href="'.URL_LMS_SERIES_EDIT.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>
                      ';
        ...
        {
        	return '<strong><a href="'.URL_LMS_SERIES_UPDATE_SERIES.$records->slug.'">'.$records->title.'</strong></a>';
        })
        ->editColumn('image', function($records)
        {
          ...
          if($records->image)
            ...
            return '<img src="'.$image_path.'" height="60" width="60"  class="img-circle" />';
        })
