...
class SubjectsController extends Controller
{
    ...
    public function getDatatable()
    {
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
            ...
            $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_SUBJECTS_EDIT.'/'.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
      ...
      ->editColumn('subject_title',function($records){
             ...
             return '<strong>'.$records->subject_title.'</strong>';
