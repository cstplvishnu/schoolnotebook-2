...
class LibraryAssetTypeController extends Controller
{
    ...
    public function index()
    {
         if(!checkRole(getUserGrade(8)))
      {
        ...
        $data['sub_active_class']   = 'asset_types';
        $data['title']              = getPhrase('library_items');
    ...
    public function getDatatable()
    {
        ...
        ->addColumn('action', function ($records) {
             ...
             $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_LIBRARY_ASSETS_EDIT.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
    ...
    public function create()
    {
         if(!checkRole(getUserGrade(8)))
      {
    	...
    	$data['active_class']       = 'library';
      $data['sub_active_class']   = 'asset_types';
    	$data['title']              = getPhrase('create_item');
      $data['layout']             = getLayout();
