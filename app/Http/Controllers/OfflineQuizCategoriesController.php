...
{ 
    ...
    public function index()
    {
        ...
        $data['sub_active_class']   = 'offline_exam';
    ...
    public function getDatatable()
    {
        ...
        ->addColumn('action', function ($records) {
                   ...
                   $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_OFFLINEEXMAS_QUIZ_CATEGORIES_EDIT.''.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
