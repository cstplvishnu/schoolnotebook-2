...
class CouponcodesController extends Controller
{
    ...
    public function index()
    {
      if(!checkRole(getUserGrade(2)))
      {
        ...
        $data['sub_active_class']   = 'coupons_list';
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
               ...
               $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_COUPONS_EDIT.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
    ...
    public function create()
    {
      if(!checkRole(getUserGrade(2)))
      {
    	...
    	$data['record']         	 = FALSE;
    	$data['active_class']        = 'coupons';
        $data['sub_active_class']   = 'coupons_add';
    ...
    public function store(Request $request)
    {
      if(!checkRole(getUserGrade(2)))
      {
        ...
        $record->save();
        flash('success','Record added successfully', 'success');
    	return redirect(URL_COUPONS);
    }
