    ...
    public function getDatatable()
    {
        ...
        if(!checkRole(getUserGrade(2)))
        {
         ...
         $records = QuizCategory::select([   
         	'image','category',  'description', 'id','slug'])
        ...
        ->addColumn('action', function ($records) {
             ...
             $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_QUIZ_CATEGORY_EDIT.'/'.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
        ...
        ->editColumn('image', function($records){
            ...
            return '<img src="'.PREFIX.$image.'" height="60" width="60" class="img-circle" />';
        })
