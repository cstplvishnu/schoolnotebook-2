...
class LmsContentController extends Controller
{
    ...
    public function index()
    {
       if(!checkRole(getUserGrade(2)))
      {
        ...
        $data['sub_active_class']   = 'contents';
        $data['title']              = 'LMS'.' '.getPhrase(' contents');
    ...
    $records = LmsContent::join('subjects', 'lmscontents.subject_id', '=', 'subjects.id')
    		->select(['lmscontents.image','lmscontents.title','lmscontents.content_type', 'subjects.subject_title','lmscontents.slug', 'lmscontents.id','lmscontents.updated_at' ])
        ...
        ->addColumn('action', function ($records) {
              $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_LMS_CONTENT_EDIT.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
        ...
        ->editColumn('image', function($records){
            ...
            return '<img src="'.$image_path.'" height="50" width="50"  class = "img-circle"/>';
        })
