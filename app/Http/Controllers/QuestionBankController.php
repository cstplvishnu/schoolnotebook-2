  ...
  public $columns = '';
    ...
    public function index()
    {
        if(!checkRole(getUserGrade(2)))
      {
        ...
        $data['sub_active_class']   = 'question_bank';
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
             ...
             return '<p id="social-buttons">
                      ...
                      <a href="'.URL_QUESTIONBANK_VIEW.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("view").'"  class="btn btn-sm btn-icon btn-primary"><i class="fa fa-eye"></i></a>

                      <a href="'.URL_QUESTIONBANK_ADD_QUESTION.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("add").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-plus-circle"></i></a>
        ...
        ->editColumn('subject_title', function($records) {
            return '<strong><a href="'.URL_QUESTIONBANK_VIEW.$records->slug.'">'.$records->subject_title.'</strong></a>';
        })
        // ->removeColumn('id')
        ->removeColumn('slug')
        ->removeColumn('is_lab')
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
              ...
              return '<p id="social-buttons">
                      ...
                      <a href="'.URL_QUESTIONBANK_EDIT_QUESTION.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>
        ...
        ->editColumn('question', function($results){
        	return '<strong><span title="'.$results->question.'">'.str_limit($results->question, 10).'</strong></span>';
        })
