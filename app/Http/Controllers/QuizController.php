      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
           ...
           $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_QUIZ_UPDATE_QUESTIONS.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("update_questions").'"  class="btn btn-sm btn-icon btn-success"><i class="fa fa-spinner"></i></a>
        ...
        {
          return '<strong><a href="'.URL_QUIZ_UPDATE_QUESTIONS.$records->slug.'">'.$records->title.' <span class="text-danger">('.$records->quiz_id.')</span>'.'</strong></a>';
        })
        ->editColumn('dueration',function($records){
          return $records->dueration.' '.getPhrase('minutes');
        })
