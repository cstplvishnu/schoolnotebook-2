...
class PublishersController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!checkRole(getUserGrade(8)))
      {
        ...
        $data['sub_active_class']   = 'publishers';
    ...
    public function getDatatable()
    {
         ...
         $records = Publisher::select([   
         	'publisher', 'country',  'id','slug'])->orderby('updated_at','desc');
        ...
        ->addColumn('action', function ($records) {
             ...
             $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_PUBLISHERS_EDIT.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
        ...
        ->editColumn('publisher',function($records){
             
             return '<strong>'.$records->publisher.'</strong>';
