  ...
  public $excel_data = array();
    ...
    public function index()
    {
      if(!checkRole(getUserGrade(2)))
      {
        ...
        $data['active_class1']      = '';
        $data['sub_active_class']   = 'offline_exams';
    ...
    public function getDatatable($slug = '')
    {
...

      {
        ...
        ->select(['quizzes.title','quizofflinecategories.title as quiz_offline_category','subjects.subject_title','quizzes.total_marks','quizzes.pass_percentage', 'quizzes.type',  'quizzes.id','quizzes.slug' ])
        ...
        return Datatables::of($records)
         ...
         ->addColumn('action', function ($records) {
            ...
            $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_OFFLINE_EXAMS_SELECTION_VIEW.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("update_marks").'"  class="btn btn-sm btn-icon btn-success"><i class="fa fa-spinner"></i></a>

                      <a href="'.URL_QUIZ_EDIT.'/'.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
         ...
         ->editColumn('title', function($records)
         {
              ...
              return '<strong><a href="'.URL_OFFLINE_EXAMS_SELECTION_VIEW.$records->slug.'">'.$records->title.'<span class="text-danger"> ('.$records->id.')</span>'.'</a></strong>';
        })
    ...
    public function entermarks(Request $request)
    {
      if(!checkRole(getUserGrade(2)))
      {
        ...
        {
            flash('Oops...!','please_select_the_details', 'warning');
      ...
      if($course_record->course_dueration>1 && $course_record->is_having_semister==1){
       ...
       elseif($course_record->course_dueration>1 && $course_record->is_having_semister!=1){
        ...
        flash('Oops...!','no_students_available', 'warning');
