    ...
    public function getDatatable()
    {
       if(!checkRole(getUserGrade(2)))
      {
        ...
        return back();
         ...
         ->select([  
            'topic_name','subjects.subject_title','parent_id', 'topics.slug', 'topics.id', 'topics.updated_at'])
        ...
        ->addColumn('action', function ($records) {
               ...
               $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_TOPICS_EDIT.'/'.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
        ...
        {
          return '<strong>'.$records->topic_name.'<span class="text-danger"> ('.$records->id.')</span>'.'</strong>';
        })
