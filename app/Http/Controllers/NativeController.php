    	...
    	if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
           ...
           $link_data = '<p id="social-buttons">
                      ...
                      <a href="'.URL_LANGUAGES_UPDATE_STRINGS.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("update_strings").'"  class="btn btn-sm btn-icon btn-success"><i class="fa fa-wrench"></i></a>

                       <a href="'.URL_LANGUAGES_EDIT.'/'.$records->slug.'" data-toggle="tooltip" data-placement="auto" title="'.getPhrase("edit").'"  class="btn btn-sm btn-icon btn-info"><i class="fa fa-pencil"></i></a>';
        ...
        {
            return '<strong><a href="'.URL_LANGUAGES_UPDATE_STRINGS.$records->slug.'">'.$records->language.'</strong></a>';
        })
