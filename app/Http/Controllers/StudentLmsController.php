...
class StudentLmsController extends Controller
{
    ...
    public function index()
    {
      if(checkRole(getUserGrade(2)))
      {
        ...
        $data['sub_active_class']   = 'lms_categories';
    ...
    public function series()
    {
      ...
      { 
        ...
        $data['active_class']       = 'lms';
        $data['sub_active_class']   = 'lms_series';
        $data['title']              = 'LMS'.' '.getPhrase('series');
        $data['layout']             = getLayout();
        $data['series']             = [];
      ...
      { 
        ...
        if($isValid = $this->isValidRecord($record))
         ...
         if($content_record){
            ...
            $pathToFile= $mypath.'/'."uploads/lms/content"."/".$content_record->file_path;
              ...
              flash('Ooops','File Does Not Exit','warning');
              return back();
            }
