...
Route::get('forgot-password', 'Auth\LoginController@getForgotPassword');
Route::post('login', 'Auth\LoginController@postLogin');

Route::get('logout', function(){

    if(Auth::check()){
        flash('success','you_are_logged_out_successfully','success');
    }
...
Route::get('student/online-registration','Auth\RegisterController@studentOnlineRegistration');
Route::post('get/users-search','UsersController@getSearchUsers');



// //Fee Schedules
// Route::get('fee/schedules', 'FeeschedulesController@index');
// Route::get('fee/schedules/add', 'FeeschedulesController@create');
// Route::post('fee/schedules/add', 'FeeschedulesController@store');
// Route::get('fee/schedules/edit/{slug}', 'FeeschedulesController@edit');
// Route::patch('fee/schedules/edit/{slug}', 'FeeschedulesController@update');
// Route::delete('fee/schedules/delete/{id}', 'FeeschedulesController@delete');
// Route::get('fee/schedules/getList', [ 'as'   => 'feeschedules.dataTable',
//     'uses' => 'FeeschedulesController@getDatatable']);
// Route::post('fee/schedules/getScheduledCourses', 'FeeschedulesController@getScheduledCourses');


// //Fine Master
// Route::get('fee/fines', 'FinesController@index');
// Route::get('fee/fines/add', 'FinesController@create');
// Route::post('fee/fines/add', 'FinesController@store');
// Route::get('fee/fines/edit/{slug}', 'FinesController@edit');
// Route::patch('fee/fines/edit/{slug}', 'FinesController@update');
// Route::delete('fee/fines/delete/{id}', 'FinesController@delete');
// Route::get('fee/fines/getList', [ 'as'   => 'fines.dataTable',
//     'uses' => 'FinesController@getDatatable']);


// //Discounts Master
// Route::get('fee/feediscounts', 'FeeDiscountsController@index');
// Route::get('fee/feediscounts/add', 'FeeDiscountsController@create');
// Route::post('fee/feediscounts/add', 'FeeDiscountsController@store');
// Route::get('fee/feediscounts/edit/{slug}', 'FeeDiscountsController@edit');
// Route::patch('fee/feediscounts/edit/{slug}', 'FeeDiscountsController@update');
// Route::delete('fee/feediscounts/delete/{id}', 'FeeDiscountsController@delete');
// Route::get('fee/feediscounts/getList', [ 'as'   => 'feediscounts.dataTable',
//     'uses' => 'FeeDiscountsController@getDatatable']);
